...
public class pedido_interfaz extends javax.swing.JPanel {
    ...
    private boolean borre;
    /**
     * Creates new form pedido_interfaz
     */
    public pedido_interfaz(Producto producto, int cantidad, Logica logica,JPanel jPanel) {
        initComponents();
        ...
        cant.setText(Integer.toString(this.cantidad));
    ...
    private void borrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_borrarActionPerformed
        ...
        borre=true;
        logica.eliminarElementoPanel(jPanel);
    ...
    public boolean isBorre() {
        return borre;
    }

    public void setBorre(boolean borre) {
        this.borre = borre;
    }
